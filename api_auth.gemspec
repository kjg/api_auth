...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency "actionpack", "> 2.3.2", "< 4.0"
  s.add_development_dependency "activesupport", "> 2.3.2", "< 4.0"
  s.add_development_dependency "activeresource", "> 2.3.2", "< 4.0"
